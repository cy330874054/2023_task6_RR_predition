...
def test_tokenize(train_input_json):
    # [_, train_input_json] = sys.argv
...
def tokenize(train_input_json,dev_input_json,test_input_json):
...
tokenize("datasets/pubmed-20k/train.json",'datasets/pubmed-20k/dev.json','datasets/pubmed-20k/test.json')
#test_tokenize("test_data.json")